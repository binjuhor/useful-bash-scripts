...
mysql -uroot -e "CREATE DATABASE ${PROJECT_NAME} /*\!40100 DEFAULT CHARACTER SET ${charset} */;"
mkdir $PROJECT_NAME
cd $PROJECT_NAME
wp core download
wp core config --dbhost=$DB_HOST --dbname=$PROJECT_NAME --dbuser=$DB_USER --dbpass=$DB_ROOT_PASS
